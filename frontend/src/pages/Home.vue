    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <p>We guarantee to use fresh food with the best quality. Customers will enjoy Continental cuisine with
                    explosive, sophisticated flavors.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/pubhome-3.jpg" alt="" class="home-img">
        ...
        <div class="home-category">
            ...
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/appetizer/appetizer-1.jpeg" alt="">
                <h3>appetizer</h3>
            </router-link>
            ...
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/sandwich/sandwich-1.jpeg" alt="">
                <h3>sandwich</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/pizza/pizza-1.jpeg" alt="">
                <h3>pizzas</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/pasta/pasta1.jpeg" alt="">
                <h3>pastas</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/chicken/chicken-2.jpeg" alt="">
                <h3>non veg</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/fries/fries-1.png" alt="">
                <h3>fries</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/maincourse/maincourse-11.jpeg" alt="">
                <h3>main course</h3>
            </router-link>
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <p>Food to customers is always guaranteed of the best quality. Promising to bring explosive, delicate, impressive flavors. Our delivery
