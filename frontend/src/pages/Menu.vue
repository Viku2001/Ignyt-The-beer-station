        ...
        <div class="row">
            <div class="col-sm-4 col-12 filter-box">
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            <input type="button" name="rPrice" id="rtfPrice" value="100,200" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rtfPrice" class="d-flex justify-content-between">Rs 100 - Rs 200 <button
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rftPrice" value="100,200" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rftPrice" class="d-flex justify-content-between">Rs 100 - Rs 200 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="200,400" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between">Rs 200 - Rs 400 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="mtPrice" value="400" hidden
                                @click="filterPriceBtn($event)" />
            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="friesFilterFoodBtn" name="friesFilterFoodBtn" class="menu-tab-item"
                            value="fries" @click="filterFoodBtn($event)" />
                        ...
                        <input type="button" id="nachosFilterFoodBtn" name="nachosFilterFoodBtn" class="menu-tab-item"
                            ...
                            <input type="button" id="appetizerFilterFoodBtn" name="appetizerFilterFoodBtn" class="menu-tab-item"
                            value="appetizer" @click="filterFoodBtn($event)" />



                        <input type="button" id="maincourseFilterFoodBtn" name="maincourseFilterFoodBtn" class="menu-tab-item"
                        ...
                        <input type="button" id="happyhoursFilterFoodBtn" name="happyhoursFilterFoodBtn" class="menu-tab-item"
                            value="happyhours" @click="filterFoodBtn($event)" />
