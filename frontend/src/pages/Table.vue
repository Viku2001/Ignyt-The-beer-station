    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons ">
                ...
                <h3>11:00am to 11:00pm</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-2.png" alt="">
                <h3>+91 82177 79517</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-3.png" alt="">
                <h3>178/6 14th main road, 20th, 50th Main Rd, Kumaraswamy Layout, Bengaluru, Karnataka 560078</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="input-box">
                    <iframe class="map"
                        src="https://www.google.com/maps/dir//178%2F6+14th+main+road,+20th,+50th+Main+Rd,+Kumaraswamy+Layout,+Bengaluru,+Karnataka+560078/@12.9075333,77.4816772,12z/data=!3m1!4b1!4m8!4m7!1m0!1m5!1m1!1s0x3bae1519a60e7f6d:0x743cf4ee0c36a725!2m2!1d77.5640791!2d12.9075462?entry=ttu"
                        loading="lazy"></iframe>
                </div>
            </div>
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.orderObj.phone) {
                ...
                if (!this.orderObj.phone.startsWith('')) {
                    this.errorObj.phoneErr.push('Phone numbers must start with blank');
                }
            ...
            if (this.orderObj.card) {
                ...
                if (this.orderObj.card.length != 16) {
                    this.errorObj.cardErr.push('Card number must have exactly 16 digits');
                }
            }
            ...
            if (!this.orderObj.when) {
                ...
                if (dateInput.getHours() < 11 || dateInput.getHours() > 23) {
                    this.errorObj.whenErr.push("Store open from 11:00 AM to 11:00 PM everyday");
                }
            }
