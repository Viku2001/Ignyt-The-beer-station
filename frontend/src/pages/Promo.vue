    ...
    <div class="promotions">
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="align-middle">10:00 - 16:00</td>
                            <td>
                        ...
                        <tr>
                            <td class="align-middle">17:00 - 19:00</td>
                            <td class="bg-light-gray">

                            </td>
                            <td>
                                <span class="bg-earth activity-name">Evening Snack</span>
                        ...
                        <tr>
                            <td class="align-middle">19:00 - 23:00</td>
                            <td class="bg-light-gray">
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                ...
                <ul>
                    <li>
                        <p>Free 01 Michelada when total bill more than Rs1600</p>
                    </li>
                    <li>
