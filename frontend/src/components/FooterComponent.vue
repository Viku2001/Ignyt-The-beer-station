<template>
    <div class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>opening hours</h3>
                <p>everyday : 11:00am to 11:00pm</p>
        ...
        <div class="bottom">
            ...
            <ul>
                ...
                <li><strong> <h4>Phone: +91 82177 79517</h4></strong></li>
                <a href="https://www.instagram.com/ignyt_thebeerstation/?hl=en/" class="fab fa-instagram"></a>
